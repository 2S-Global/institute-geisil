...
const timeline = [
  ...
  },
  {
    ...
    desc: "DSA + System design + DSA-2",
    color: "text-warning",
    done: true,
  },
  {
    date: "Apr 18",
    title: "Final interview cleared",
    desc: "Hiring manager round + culture fit",
    color: "text-accent",
    done: true,
  },
  {
    ...
    desc: "₹ 32 LPA package issued by Google India",
    color: "text-primary",
    done: true,
  },
  {
    ...
    desc: "Candidate signed offer letter",
    color: "text-success",
    done: true,
  },
  {
    ...
    <DashboardLayout>
      ...
      >
        <Link to="/institute/placements">
          <ArrowLeft className="h-4 w-4" /> Back to placements
        </Link>
      </Button>
      ...
      <div className="grid gap-5 lg:grid-cols-3 mb-6">
          ...
          <CardContent>
            <div className="grid sm:grid-cols-2 gap-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-foreground">₹ 32.0 LPA</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="h-12 w-12 rounded-lg bg-warning/10 text-warning flex items-center justify-center">
                  <MapPin className="h-5 w-5" />
                </div>
                <div>
                  <p className="text-xs text-muted-foreground">Location</p>
                  <p className="font-semibold text-foreground">Bengaluru, KA</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid sm:grid-cols-3 gap-4 text-sm">
              <div>
                ...
                <p className="text-foreground font-medium">July 14, 2026</p>
              </div>
              <div>
                <p className="text-xs text-muted-foreground">Bond</p>
                <p className="text-foreground font-medium">None</p>
              </div>
              <div>
                <p className="text-xs text-muted-foreground">Probation</p>
                <p className="text-foreground font-medium">3 months</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-border/60 shadow-sm">
          ...
          <CardContent>
            ...
            <Badge
              variant="outline"
              className="bg-success/10 text-success border-success/20 w-full justify-center py-1.5"
            >
      ...
      <div className="grid gap-5 lg:grid-cols-2">
        ...
        <Card className="border-border/60 shadow-sm">
          ...
          <CardContent className="divide-y divide-border/60 p-0">
            {[
              { n: "Offer_Letter_Google.pdf", s: "284 KB" },
              { n: "Joining_Kit.pdf", s: "1.4 MB" },
              { n: "Background_Check_Consent.pdf", s: "112 KB" },
            ].map((d) => (
              <div
                key={d.n}
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-foreground text-sm">{d.n}</p>
