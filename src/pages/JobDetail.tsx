    ...
    const fetchJobDetails = async () => {
      ...
      try {
        const response = await api.get(
          "/api/jobposting/get_job_previewDetails",
          {
            params: { jobId: id },
          },
        );
        ...
        <main className="flex-1 px-4 sm:px-6 lg:px-8 py-4 md:py-6 lg:py-8">
          <div className="space-y-6">
            ...
            <Card className="overflow-hidden">
              <Link
                to="/job-search"
                className="inline-flex  p-2 items-center gap-2 text-sm text-muted-foreground hover:text-foreground"
              >
                    ...
                    <Card>
                      <CardHeader>
                        <CardTitle className="text-lg flex items-center gap-2">
                          <Sparkles className="h-5 w-5 text-primary" /> Your
                          match analysis
                        </CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-4">
                ...
                {/* <Card className="bg-primary text-primary-foreground">
                  <CardContent className="p-5 space-y-3">
                    ...
                    <p className="text-sm text-primary-foreground/80">
                      Candidates with a complete profile are 4× more likely to
                      be shortlisted.
                    </p>
