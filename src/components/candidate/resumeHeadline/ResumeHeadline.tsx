      ...
      <div className="px-6 py-5">
        ...
        <div className="relative">
          ...
          <button
            ...
            className="absolute bottom-3 left-3 flex items-center gap-2 rounded-full bg-blue-50 px-3 py-1.5 text-sm font-medium text-blue-600 transition hover:bg-blue-100"
          >
