            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="mt-2 text-sm">
                  {userdata?.pan_number ? (
                    <div className="text-gray-600">
                      <div><span className="font-semibold">Name:</span> {userdata.pan_name}</div>
                      <div><span className="font-semibold">PAN:</span> {userdata.pan_number}</div>
                    </div>
                  ) : (
                    <span className="font-semibold text-blue-600 cursor-pointer" onClick={() => openModalRH("pan")}>Add PAN info</span>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-2 text-sm">
                  {userdata?.dl_number ? (
                    <div className="text-gray-600">
                      <div><span className="font-semibold">Name:</span> {userdata.dl_name}</div>
                      <div><span className="font-semibold">DL Number:</span> {userdata.dl_number}</div>
                    </div>
                  ) : (
                    <span className="font-semibold text-blue-600 cursor-pointer" onClick={() => openModalRH("dl")}>Add Driving License Info</span>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-2 text-sm">
                  {userdata?.epic_number ? (
                    <div className="text-gray-600">
                      <div><span className="font-semibold">Name:</span> {userdata.epic_name}</div>
                      <div><span className="font-semibold">EPIC Number:</span> {userdata.epic_number}</div>
                    </div>
                  ) : (
                    <span className="font-semibold text-blue-600 cursor-pointer" onClick={() => openModalRH("epic")}>Add EPIC Details</span>
                  )}
                </div>
              </div>
