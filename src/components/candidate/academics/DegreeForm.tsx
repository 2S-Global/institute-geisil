      ...
      >
        ...
        <div>
          <label className="mb-2 block text-sm font-medium text-gray-700">
            Course Start and End Year <span className="text-red-500">*</span>
          </label>
          ...
          <div className="grid grid-cols-1 items-center gap-4 md:grid-cols-[1fr_auto_1fr]">
            ...
            >
              ...
              {Array.from(
                { length: currentYear - firstAllowedYear + 1 },
                (_, i) => {
                  const year = firstAllowedYear + i;

                  const isDisabled =
                    formData.end_year && year > Number(formData.end_year);
            ...
            >
              ...
              {Array.from(
                ...
                (_, i) => {
                  ...
                  const isDisabled =
                    formData.start_year &&
                    year < Number(formData.start_year) + minimumCourseDuration;
