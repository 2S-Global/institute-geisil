  ...
  useEffect(() => {
    if (isOpen) {
      if (isEditMode) {
        ...
        setExperienceYear(
          editData.experienceyear !== undefined
            ? String(editData.experienceyear)
            : "",
        );
        setExperienceMonth(
          editData.experiencemonth !== undefined
            ? String(editData.experiencemonth)
            : "",
        );
      } else {
        ...
        <form onSubmit={handleSubmit} className="px-6 pb-6">
          <div className="flex items-start justify-between bg-white mt-1 mb-4">
            <p className="text-sm text-gray-600 leading-relaxed">
              Mention skills like communication, teamwork, problem-solving,
              leadership, and other personal strengths to highlight your overall
              abilities.
            </p>
          </div>
