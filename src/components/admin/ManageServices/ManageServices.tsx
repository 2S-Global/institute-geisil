...
//   const [currentService, setCurrentService] = useState({ _id: '', title: '', description: '' });
...
//       const response = await API.put(`/api/home/update-service-details/${currentService._id}`, payload);
...
//     try {
//       const response = await API.put(`/api/home/delete-service-details/${serviceToDelete._id}`);
...
//             <p className="text-sm text-gray-500">Configure and manage services displayed across your platform.</p>
//           </div>
...
//             <Button
//               onClick={() => {
//                 setCurrentService({ _id: '', title: '', description: '' });
...
//                           className="text-blue-600 hover:text-blue-700 hover:bg-blue-400"
//                         >
...
//                 ) : (
//                   <tr>
//                     <td colSpan="3" className="text-center py-8 text-gray-400">No services found.</td>
//                   </tr>
//                 )}
//               </tbody>
//             </table>
...
//             <div className="bg-white rounded-xl shadow-2xl w-full max-w-xl overflow-hidden border border-gray-100">
//               <div className="flex justify-between items-center px-6 py-4 border-b border-gray-100">
//                 <h3 className="text-lg font-bold text-gray-800">Add New Service</h3>
//                 <button onClick={() => setIsAddModalOpen(false)} className="text-gray-400 hover:text-gray-600 font-bold text-lg">
//                   &times;
//                 </button>
//               </div>
...
//                     type="text"
//                     name="title"
//                     placeholder="Service Title (e.g. 🆔 KYC Verification)"
...
//                     <div className="flex flex-wrap items-center gap-1 p-2 bg-gray-50 border-b border-gray-200 text-gray-600 text-xs">
//                       <span className="px-2 py-1 bg-white border border-gray-200 rounded font-medium">
//                         Normal ▼
//                       </span>
//                       <div className="h-4 w-[1px] bg-gray-300 mx-1"></div>
//                       <button type="button" className="px-2 py-1 hover:bg-gray-200 rounded font-bold">B</button>
...
//                       <button type="button" className="px-2 py-1 hover:bg-gray-200 rounded line-through">S</button>
//                       <div className="h-4 w-[1px] bg-gray-300 mx-1"></div>
//                       <button type="button" className="px-2 py-1 hover:bg-gray-200 rounded">List</button>
//                       <button type="button" className="px-2 py-1 hover:bg-gray-200 rounded">Link</button>
//                       <button type="button" className="px-2 py-1 hover:bg-gray-200 rounded">Image</button>
//                     </div>
//                     <textarea
//                       name="description"
//                       rows="6"
...
//                   <Button
//                     type="submit"
//                     className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 rounded-lg text-sm shadow transition"
//                   >
//                     Save
//                   </Button>
//                   <Button
...
//                     className="w-full bg-gray-500 hover:bg-gray-600 text-white font-medium py-2.5 rounded-lg text-sm transition"
//                   >
//                     Cancel
//                   </Button>
//                 </div>
...
//             <div className="bg-white rounded-xl shadow-2xl w-full max-w-xl overflow-hidden border border-gray-100">
//               <div className="flex justify-between items-center px-6 py-4 border-b border-gray-100">
//                 <h3 className="text-lg font-bold text-gray-800">Update Service</h3>
//                 <button onClick={() => setIsUpdateModalOpen(false)} className="text-gray-400 hover:text-gray-600 font-bold text-lg">
//                   &times;
//                 </button>
//               </div>
...
//               <AlertDialogDescription>
//                 This action cannot be undone. This will permanently delete the service &quot;{serviceToDelete?.title}&quot; from the server.
//               </AlertDialogDescription>
//             </AlertDialogHeader>
//             <AlertDialogFooter>
      ...
      <div className="p-4 sm:p-6 lg:p-8 bg-gray-50 min-h-screen font-sans">
        ...
        {isAddModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-3 sm:p-4 overflow-y-auto">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg md:max-w-xl overflow-hidden border border-gray-100 my-auto max-h-[90vh] flex flex-col">
