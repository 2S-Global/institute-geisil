...
import ManageCampus from "./pages/ManageCampus.tsx";
...
import Campus from "./pages/ManageCampus.tsx";
                ...
                element={
                  <ProtectedRoute role="3">
                    <Routes>
                      ...
                      />
                      <Route
                        path="/institute-profile-details"
                        element={<InstituteProfileDetails />}
                      />
                      <Route
                        path="/manage-courses"
                      ...
                      />
                      <Route path="/manage-campus" element={<Campus />} />
                      <Route path="*" element={<NotFound />} />
                    </Routes>
                  </ProtectedRoute>
                }
                ...
                element={
                  <ProtectedRoute role="2">
                    <Routes>
                      ...
                      <Route
                        path="/review-edit-jobs/:id"
                        element={<ReviewEditJobs />}
                      />
                      ...
                      <Route
                        ...
                        element={<VerifiedDetailsPage />}
                      />
                      <Route
                        path="/verified-aadhar"
                        element={<VerifiedAadharPage />}
                      />
                      <Route
